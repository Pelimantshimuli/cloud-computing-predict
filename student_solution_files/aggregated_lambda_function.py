...
#               }
    ...
    table = dynamodb.Table('2401FTDE-PREMAN-portfolio-data-table')
    ...
    # --- Insert your code here ---
    enquiry_text = dec_dict['email'] # <--- Insert code to place the website message into this variable
    # -----------------------------
    ...
    critical_phrase_list = ['github', 'git', 'Git','GitHub', 'projects', 'portfolio','Portfolio','C.V', 'resume', 'Curriculum Vitae','Resume', 'CV','cv','data', 'science','Article','article', 'Articles','articles']
    ...
    # email_text = 'Please find the attached.'
